...
public class Tube : MonoBehaviour
{
    ...
    void Start()
    {
        _renderer = transform.Find("F_Liquid_02").GetComponent<Renderer>();
    }
    ...
    {
        _renderer.material.SetFloat("_Height", height);
        _renderer.material.SetColor("_Color1", Color.Lerp(_renderer.material.GetColor("_Color1"), color, 0.5f));
    }

    public void finalFill(float height, int b)
    {
        if (b == 0)
        {
            _renderer.material.SetFloat("_Height", height);
        ...
        {
            _renderer.material.SetFloat("_Height", height);
            _renderer.material.SetColor("_Color1", Color.Lerp(Color.blue, Color.red, 0.5f));
        }else if(b == 2)
        {
            _renderer.material.SetColor("_Color1", Color.blue);
        }
    }
